...
const { getAll, getDataCount, create, update, deleteData } = require("../model/tuk");
...
module.exports = {
  getAll: async (request, response) => {
    ...
    const pageInfo = {
      ...
      limit,
      totalData,
      prevLink: prevLink && `http://127.0.0.1:3002/tuk?${prevLink}`,
      nextLink: nextLink && `http://127.0.0.1:3002/tuk?${nextLink}`,
    };
    try {
