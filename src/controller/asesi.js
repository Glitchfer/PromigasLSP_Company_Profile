...
const { getAll, getDataCount, create, update, deleteData } = require("../model/asesi");
...
module.exports = {
  getAll: async (request, response) => {
    ...
    const pageInfo = {
      ...
      limit,
      totalData,
      prevLink: prevLink && `http://127.0.0.1:3002/asesi?${prevLink}`,
      nextLink: nextLink && `http://127.0.0.1:3002/asesi?${nextLink}`,
    };
    try {
